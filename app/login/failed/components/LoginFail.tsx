    ...
    return (
        <div className="flex justify-center p-8">
            <div className="flex flex-col gap-4 bg-neutral-50 dark:bg-neutral-900 p-4 rounded-md max-w-sm w-full mt-10">
                <h1 className="text-xl">Error de Inicio de Sesión</h1>
                <div className="flex flex-col gap-2">
                    <p className="text-sm">
                        {errorMessage}
                    </p>
                    <p className="text-xs opacity-60">
                        Consejo: Asegúrate de abrir el enlace en el mismo dispositivo/navegador desde el que intentaste registrarte.
                    </p>
                </div>
                <div>
                    <Link href={"/login"}>
